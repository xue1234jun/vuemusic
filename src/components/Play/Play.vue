      ...
      <div class="skin">
        <transition name="slide-fade">
          <div v-show="isShowSkinColors" class="skin-colors">
            ...
            <i @click="changeSkinColor('#1565C0')" :class="{selected: skinColor==='#058ecc'}" class="two"></i>
        ...
        <div @click="showSkinColor" :class="{'icon-skin-red': skinColor === '#B72712','icon-skin-blue': skinColor === '#058ecc','icon-skin-black': skinColor === '#212121','icon-skin-green': skinColor === '#1B5E20'}" class="icon-skin"></div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      defaultImg: 'http://www.xjblog.win/images/avatar.png',
